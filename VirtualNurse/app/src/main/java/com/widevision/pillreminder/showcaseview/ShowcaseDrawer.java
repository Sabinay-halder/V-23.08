...
public interface ShowcaseDrawer {
     ...
     * your implementation of {@link #drawShowcase(android.graphics.Bitmap, float, float, float)}
     ...
     * but typically this should be the color used to draw in {@link #erase(android.graphics.Bitmap)}
     */
