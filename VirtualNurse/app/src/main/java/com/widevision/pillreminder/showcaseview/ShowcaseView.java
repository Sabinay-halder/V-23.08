...
import com.widevision.pillreminder.showcaseview.targets.Target;
...
private static int btnTag = -1;
    ...
    public void overrideButtonClick(OnClickListener listener) {
        ...
        if (btn != null) {
            if (listener != null) {
                ...
                btn.setOnClickListener(hideOnClickListenerSkip);
            }
        }
    ...
    private void recalculateText() {
        ...
        if (recalculateText) {
            ...
            textDrawer.calculateTextPosition(getMeasuredWidth(), (int) (getMeasuredHeight() / 0.5), shouldCentreText, rect);
        }
    ...
    public void hide(int i) {
        ...
        mEventListener.onShowcaseViewHide(this,i);
        fadeOutShowcase();
    }
    ...
    /**
     * Builder class which allows easier creation of {@link com.widevision.pillreminder.showcaseview.ShowcaseView}s.
    ...
    public static class Builder {
         ...
         * by {@link #setOnClickListener(android.view.View.OnClickListener)}, so call this method before that one.
         */
        public Builder replaceEndButton(Button button, Context c) {
            showcaseView.setEndButton(button, c);
        ...
        public Builder replaceEndButton(int buttonResourceId) {
            ...
            return replaceEndButton((Button) view,activity);
        }

        public Builder replaceSkip(int buttonResourceId) {
            View view = LayoutInflater.from(activity).inflate(buttonResourceId, showcaseView, false);
    ...
    private void setEndButton(Button button, Context c) {
       ...
       // btn.setBackgroundColor(getResources().getColor(R.color.white));
        btn.setBackground(getResources().getDrawable(R.drawable.dialog_rect_white_background));
        int margin = (int) getResources().getDimension(R.dimen.button_margin);
        int margin2 = (int) getResources().getDimension(R.dimen.button_margin);
        layoutParams.setMargins(margin, margin2, margin, margin2);

        layoutParams.addRule(RelativeLayout.LEFT_OF,mEndButton.getId());
        btn.getBackground().setColorFilter(showcaseColor, PorterDuff.Mode.MULTIPLY);
        addView(btn);
    }
    ...
    private OnClickListener hideOnClickListenerSkip = new OnClickListener() {
        @Override
        public void onClick(View v) {
            hide(1);
        }
